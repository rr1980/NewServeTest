...
namespace NewServeTest.Logger.Internal
{
    public class BatchingLogger : ILogger
    {
        ...
        public BatchingLogger(BatchingLoggerProvider loggerProvider, string categoryName, IHttpContextAccessor accessor)
        {
        ...
        public void Log<TState>(DateTimeOffset timestamp, LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
        {
            ...
            builder.Append("] ");
            builder.Append("[");
            builder.Append(string.IsNullOrEmpty(remoteIp) ? "SERVER" : "IP: " + remoteIp);
            builder.Append("] ");
