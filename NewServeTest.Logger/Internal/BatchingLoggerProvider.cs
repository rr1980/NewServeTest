...
namespace NewServeTest.Logger.Internal
{
    public abstract class BatchingLoggerProvider : ILoggerProvider, ISupportExternalScope
    {
        ...
        protected BatchingLoggerProvider(IOptionsMonitor<BatchingLoggerOptions> options, IHttpContextAccessor accessor)
        {
        ...
        {
            return new BatchingLogger(this, categoryName, _accessor);
        }
